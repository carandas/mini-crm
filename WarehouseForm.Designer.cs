namespace MiniBiz
{
	partial class WarehouseForm
	{
		...
		private void InitializeComponent()
		{
			...
			dataGridView1.Size = new Size(1011, 279);
			...
			ButtonSaveToCsv.Location = new Point(24, 376);
			...
			SearchGroupBox.Location = new Point(291, 313);
			...
			Name = "WarehouseForm";
			Text = "WarehouseForm";
			FormClosing += WarehouseForm_FormClosing;
